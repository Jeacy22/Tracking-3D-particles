...
class MyDataSet(Dataset):
    ...
    def __getitem__(self,index):
        ...
        batch_hm = np.zeros((self.output_shape[0],self.output_shape[1],self.classes_amount),dtype=np.float32)
        batch_offset = np.zeros((self.output_shape[0],self.output_shape[1],self.classes_amount),dtype=np.float32)
        ...
        for box in boxes:
            ...
            if sh>0 and sw>0:
                ...
                batch_depth[ct_int[1],ct_int[1]] =box[4]
